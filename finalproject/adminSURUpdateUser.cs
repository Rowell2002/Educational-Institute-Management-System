...
{
    public partial class adminSURUpdateUser : Form
    {
     ...
     (
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string sql = "UPDATE stDetails_tbl SET contact=@contact,fname=@fname,lname=@lname,email=@email,address=@address WHERE st_ID=@stdid or fname=@fname";
                SqlCommand command = new SqlCommand(sql, conn);
                command.Parameters.AddWithValue("@stdid", this.txt_userID.Text);
