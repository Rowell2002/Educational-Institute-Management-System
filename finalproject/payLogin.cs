...
{
    public partial class payLogin : Form
    {
       ...
       (
        ...
        private void payLogin_Load(object sender, EventArgs e)
        {
        ...
        private void btn_login_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string sql = "SELECT * FROM empDetails_tbl WHERE emp_Type='payment clerk' AND username= '" + txt_uname.Text + "' AND password = '" + txt_pwd.Text + "'";
