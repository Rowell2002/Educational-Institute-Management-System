...
{
    public partial class coLogin : Form
    {
       ...
       (
        ...
        private void btn_login_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string sql = "SELECT * FROM empDetails_tbl WHERE emp_Type='coordinator' AND username= '" + txt_uname.Text + "' AND password = '" + txt_pwd.Text + "'";
                ...
                if (dtable.Rows.Count > 0)
                {
                    ...
                    coordinator a1 = new coordinator(uname);
                    a1.Show();
                    this.Hide();
        ...
        private void coLogin_Load(object sender, EventArgs e)
        {
