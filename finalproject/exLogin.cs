...
{
    public partial class exLogin : Form
    {
       ...
       (
        ...
        private void btn_login_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string sql = "SELECT * FROM empDetails_tbl WHERE emp_Type='examination officer' AND username= '" + txt_uname.Text + "' AND password = '" + txt_pwd.Text + "'";
                ...
                if (dtable.Rows.Count > 0)
                {
                   ...
                   examinationOfficer e1 = new examinationOfficer(uname);
                    e1.Show();
                    this.Hide();
        ...
        private void exLogin_Load(object sender, EventArgs e)
        {
